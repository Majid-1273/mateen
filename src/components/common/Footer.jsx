    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full">
        <svg
          ...
          className="w-full h-16 fill-current text-red-700 opacity-20"
        >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-full flex flex-col justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 flex-grow">
          ...
          <div data-aos="fade-up" className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {/* Keep # as dummy for social links */}
              <a
                href="#"
                className="w-10 h-10 bg-gradient-to-br from-green-600 to-green-700 rounded-full flex items-center justify-center text-white hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-110"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={idx}>
                  <Link
                    to={link.to}
                    className="text-gray-200 hover:text-red-300 transition-colors duration-200 flex items-center group"
                  >
          ...
          <div data-aos="fade-up" data-aos-delay="300">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <p className="text-gray-300 text-sm mb-3">
                Get updates on our latest collections and cultural fusion
                designs.
              </p>
              <div className="flex">
                <input
        ...
        <div className="border-t border-white/20 mt-8 pt-6 flex-shrink-0">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            ...
            {/* Removed privacy/terms/shipping as per instructions */}
          </div>
